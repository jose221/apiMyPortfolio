...
const model = require("../models/DataHerandroEventAction");
const fkModel = require("../models/User");
const DBHelper = require("../helpers/DBHelper");

class DataHerandroEventActionService {

    exclude = ['deleted_at', 'created_at', 'updated_at'];
    excludePost = ['deleted_at', 'created_at', 'updated_at', 'id'];
    current_module = 'data_herandro_event_action';
...
module.exports = new DataHerandroEventActionService();
